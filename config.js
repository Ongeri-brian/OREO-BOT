...
//OwnerShip
global.owner = [
  [process.env.OWNER_NUMBER || '0713145618', process.env.OWNER_NAME || 'Developer Shizo 🤖', true],
  ['0713145618', 'Brian Ongeri', true]
]
global.mods = []
global.prems = []

global.author = process.env.OWNER_NAME || 'Brian ongeri'
global.botname = process.env.BOT_NAME || 'Ongeri '
global.oname = author
